...
def res50(
    cfg,
    pretrained_model="./pretrain_models/resnet50-19c8e357.pth",
    last_layer_stride=2,
):
    resnet = ResNet(
        cfg,
...
def res101(
    cfg,
    pretrained_model="./pretrain_models/resnet101-5d3b4d8f.pth",
    last_layer_stride=2,
):
    resnet = ResNet(
        cfg,
...
def res152(
    cfg,
    pretrained_model="./pretrain_models/resnet152-b121ed2d.pth",
    last_layer_stride=2,
):
    resnet = ResNet(
        cfg,
...
if __name__ == "__main__":
    ...
    model = ResNet(None, BottleNeck, [3, 4, 6, 3], last_layer_stride=2)
    print(model)
